...
<head>
<title>Mimeo Proof - Flipbook Javascript</title>
<style type="text/css">
.buttons {
	font-family: arial;
	font-size: 8pt;
...
$AmazonS3_Document_URL = "http://kinlane-productions.s3.amazonaws.com/pdf-samples/The_Impact_of_Digital_Books_Upon_Print_Publishing.pdf";
...
<div align="center">	
	...
	<div id="myBook" style="display:none;">	
		...
		<div name="Home" style="background:#055123 url(/images/assets/standard_cover.png);color:#ffffff;">
			<div align=center>
			<h1>The Impact of Digital Books upon Print Publishing</h1>
			</div>
		</div>
		...
		//for ($Page = 0; $Page < 2; $Page++)
			...
			<div name="Page <?php echo $Page;?>" style="background:#FFFFFF url('http://nimbus2.laneworks.net/<?php echo $Save_Filename;?>'); color:#000000; overflow: scroll;">
...
var myPageW=600; //page width
var myPageH=580; //page height
